...
const audioQuestionsIntentHandler = {
    ...
    handle(handlerInput) {
        var speechText = 'Can you guess the band or artist?<audio src="https://s3.amazonaws.com/myaudioquiz/akon.mp3"/>';
        return handlerInput.responseBuilder
            .speak(speechText)
            .reprompt(speechText)
            .getResponse();
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const speechText = 'To play, ask me to start the quiz, to exit, ask me to stop.';
